// ignore_for_file: prefer_const_constructors, library_private_types_in_public_api, avoid_print, prefer_interpolation_to_compose_strings, use_build_context_synchronously
                    ...
                    child: ElevatedButton(
                     ...
                     onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        bool success = await updatePasswordApi.updatePassword(
                        ...
                        if (success) {
                          ...
                          // Show error SnackBar with default color
                          ScaffoldMessenger.of(context).showSnackBar(
