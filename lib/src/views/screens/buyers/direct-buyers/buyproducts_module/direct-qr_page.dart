  // ignore_for_file: file_names, use_build_context_synchronously, unnecessary_string_interpolations, avoid_print
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        actions: <Widget>[
          TextButton(
            child: const Text('Cancel', style: TextStyle(color: Color(0xFFCA771A))),
            onPressed: () {
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              // Call postOrders and log the order success
              ...
              if (orderSuccess) {
                ...
                // Show error message if the order failed to post
                ScaffoldMessenger.of(context).showSnackBar(
